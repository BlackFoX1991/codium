...
namespace codium.Compiler.LexAnalystic
{
    internal class TypeInferer
    {
        ...
        public TypeInferer()
        {
            ...
            dictInferencePlus[MakeKey(null, typelong)] = null;
            ...
            dictInferencePlus[MakeKey(typelong, null)] = null;
            dictInferencePlus[MakeKey(typeInt, typeInt)] = typeInt;
            dictInferencePlus[MakeKey(typelong, typelong)] = typelong;
            dictInferencePlus[MakeKey(typeInt, typeFloat)] = typeFloat;
            dictInferencePlus[MakeKey(typelong, typeFloat)] = typeFloat;

            dictInferencePlus[MakeKey(typeFloat, null)] = null;
            dictInferencePlus[MakeKey(typeFloat, typeInt)] = typeFloat;
            dictInferencePlus[MakeKey(typeFloat, typelong)] = typeFloat;
            ...
            dictInferencePlus[MakeKey(typeString, typelong)] = typeString;
            ...
            dictInferencePlus[MakeKey(typeArray, typelong)] = typeArray;
            ...
            dictInferenceMinus[MakeKey(null, typelong)] = null;
            ...
            dictInferenceMinus[MakeKey(typelong, null)] = null;
            dictInferenceMinus[MakeKey(typeInt, typeInt)] = typeInt;
            dictInferenceMinus[MakeKey(typelong, typelong)] = typelong;
            dictInferenceMinus[MakeKey(typeInt, typeFloat)] = typeFloat;
            dictInferenceMinus[MakeKey(typelong, typeFloat)] = typeFloat;

            dictInferenceMinus[MakeKey(typeFloat, null)] = null;
            dictInferenceMinus[MakeKey(typeFloat, typeInt)] = typeFloat;
            dictInferenceMinus[MakeKey(typeFloat, typelong)] = typeFloat;
            ...
            dictInferenceMinus[MakeKey(typeArray, typelong)] = typeArray;
            ...
            dictInferenceFactor[MakeKey(null, typelong)] = null;
