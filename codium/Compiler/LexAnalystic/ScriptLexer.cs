                ...
                switch (m_lexState)
                {
                    ...
                    case LexState.IntegerOrFloat:
                        ...
                        else
                        {
                            ...
                            {
                                // int32
                                int iValue = int.Parse(strToken, CultureInfo.InvariantCulture);
                            ...
                            catch
                            {
                                ...
                                // int64
                                long iValue = long.Parse(strToken, CultureInfo.InvariantCulture);
                                listTokens.Add(new Token(TokenType.Long, iValue,
                                    m_iSourceLine, m_iSourceChar, strSourceLine));
                            }
                            UndoChar();
                            m_lexState = LexState.Space;
                    ...
                    case LexState.Float:
                        ...
                        {
                            float fValue = float.Parse(strToken, CultureInfo.InvariantCulture);
